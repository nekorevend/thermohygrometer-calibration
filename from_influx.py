...
parser.add_argument('--start_time', '--st', required=True, type=str, help='Start time (in UTC) of the time period we want to query. Use the format "YYYY-MM-DD HH:MM:SS".')
parser.add_argument('--end_time', '--et', required=True, type=str, help='End time (in UTC) of the time period we want to query. Use the format "YYYY-MM-DD HH:MM:SS".')
parser.add_argument('--reference_temperature_sensors', '--rt', required=True, type=str, help='List of entity_ids for reference (calibrated) thermometers. Use CSV format.')
parser.add_argument('--reference_humidity_sensors', '--rh', required=True, type=str, help='List of entity_ids for reference (calibrated) hygrometers. Use CSV format.')
parser.add_argument('--uncalibrated_temperature_sensors', '--ut', required=True, type=str, help='List of entity_ids for uncalibrated temperature sensors. Use CSV format.')
parser.add_argument('--uncalibrated_humidity_sensors', '--uh', required=True, type=str, help='List of entity_ids for uncalibrated humidity sensors. Use CSV format.')
parser.add_argument('--output_to_csv', '--csv', action=argparse.BooleanOptionalAction, help='Just output the query results to CSV files. Will create files in the current directory.')
parser.add_argument('--stored_temp_unit', default='C', choices=['C', 'F'], type=str, help='What unit are the temperature values stored in? Defaults to "C".')
parser.add_argument('--reported_temp_unit', default='C', choices=['C', 'F'], type=str, help='What unit are the temperature values reported in? Defaults to "C".')
